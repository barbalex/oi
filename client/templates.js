(function (root, factory) {
    ...
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<section class="page home"><div id="content"><div id="nav" class="tab">nav</div><div id="form" class="tab">form</div><div id="map" class="tab">map</div><div id="utils" class="tab">utils</div></div></section>';
    };

...
module.exports = function () {
    window.oi.olMap.LayersControl = function (opt_options) {
    ...
    ol.inherits(window.oi.olMap.LayersControl, ol.control.Control);
    ...
    */
    window.oi.olMap.LayersControl.prototype.setMap = function(map) {
